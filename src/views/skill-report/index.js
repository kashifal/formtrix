        ...
        const fetchEmployeesAndCourses = async () => {
            try {
                const response = await axios.get(
                    `https://glowing-paradise-cfe00f2697.strapiapp.com/api/employees?filters[company][id][$eq]=${companyId}&populate=skills.courses`
                );
                                                            ...
                                                            <TableRow
                                                                ...
                                                                sx={{
                                                                    backgroundColor: getHighlightColor(
                                                                        course.completed ? course.dateExpires : null,
                                                                        course.dateExpires
                                                                    )
                                                                }}
                                                            >
