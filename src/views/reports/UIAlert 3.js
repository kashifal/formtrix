...
const EmployeeTable = () => {
    ...
    const filteredEmployees = employees.filter((employee) => {
        const companyMatch = selectedCompany ? employee.companyName === selectedCompany : true;
                    ...
                    <Grid container spacing={2} style={{ marginBottom: '16px' }}>
                        ...
                        <Grid item xs={12} sm={4}>
                            <FormControl fullWidth>
                                ...
                                <Select labelId="course-label" value={selectedCourse} onChange={handleCourseChange} label="Course">
                        ...
                        <Grid item xs={12} sm={4}>
                            <FormControl fullWidth>
                                ...
                                <Select labelId="skill-label" value={selectedSkill} onChange={handleSkillChange} label="Skill">
