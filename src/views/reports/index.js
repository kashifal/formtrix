    ...
    const fetchData = async () => {
      try {
        const employeesResponse = await axios.get(
          'https://glowing-paradise-cfe00f2697.strapiapp.com/api/employees?populate=*'
        );
        const employeesData = employeesResponse.data.data;
        const companiesResponse = await axios.get(
          'https://glowing-paradise-cfe00f2697.strapiapp.com/api/companies'
        );
        ...
        const coursesResponse = await axios.get(
          'https://glowing-paradise-cfe00f2697.strapiapp.com/api/courses'
        );
  ...
  return (
    <div style={{ height: 600, width: '100%' }} id="dataGridProContainer">
      ...
      <Paper style={{ padding: '16px', marginTop: '16px' }}>
        ...
        {response && <Alert severity="info" style={{ marginTop: '16px' }}>{JSON.stringify(response)}</Alert>}
      </Paper>
    </div>
  );
};
